...
//$save = strip_tags(trim($_POST["save"]));
		//$a=$_SESSION['username'];
$result = mysqli_query($conn,"SELECT * FROM hag where address LIKE '" . $name . "%' and test='1' ");
...
<tr>
  <td><?php echo $row["id"]; ?></td>
	...
	echo $b;
	?>
 <td><h3><a href="/ka/sal.php?kh=<?php echo $b; ?>">تاكيد</a></h3></td>
...
mysqli_query($conn," UPDATE `hag` SET  test='2'  WHERE id LIKE '" . $kh . "%'")or die("eroor");

echo" <h1 >  م استلام الحجز  </h1>";
}
?>
