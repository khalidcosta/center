...
$resu = mysqli_query($conn,"SELECT * FROM hag where test ='0'  ");
?>

<div  class="lname">
<div  class="lname1">
  <form action="/wjba/se2.php?kh=0" method ="POST" >
...
<?php 
echo'<form action="/wjba/se2.php?kh=0" method="POST">


<center>

            <button type="submit" name="sa" class="btn btn-primary btn-lg"
              style="padding-left: 2.5rem; padding-right: 2.5rem;"> تاكيد الحجز</button>
...
$conn=mysqli_connect($url,$username,$password,"wjba");
	$a=$_SESSION['phone'];
 	  ...
 	  mysqli_query($conn," UPDATE `hag` SET  test='1' WHERE nid ='$a'")or die("eroor");
